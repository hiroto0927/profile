...
- 背景色: `bg-linear-to-br from-slate-50 to-blue-50` (ホーム画面・プロフィールと統一)
- ジオメトリック背景: ホーム画面と同様のジオメトリック背景エフェクト（幾何学模様とプログラミング要素のアニメーション）を適用すること
...
`link` タグに含まれる記事への URL は card 全体にリンクを付与すること。

**モバイル**

1 列表示とし、表示項目は以下の通りとする。
